...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-base-ctor/tags). For example,

```javascript
ndarray = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-ctor@v0.2.0-umd/browser.js' )
```
